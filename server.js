...
app.post('/SignUp',(req,res)=>{
    ...
    if(req.body.email =="" || req.body.password==""){
        ...
        db.FindItem(req.body.email,(result)=>{
        
            console.log("After finding Item " + result);
        
            if(result == null){
                console.log("email null")
                
                var arr=[]
                db.SignUp(req.body.email,req.body.password,req.body.username,arr,req.body.dob,function(){ 
